    ...
    <div>
      ...
      <div className="flex flex-col items-center text-white ">
        ...
        <section id="exploration">
          <div >
            ...
            <h2 className="block lg:hidden text-xl font-medium text-center mt-8 px-6">
              Explore fun on every planet in the X-city world. Various landscapes and hiding events bring more exciting experiences for you.
            </h2>
          </div>
        </section>
        ...
        <div className="flex justify-center items-center">
          <p className=" mr-2 lg:mr-5 text-3xl lg:text-[40px] lg:leading-[48px] font-semibold text-white">THE COOLEST<br/>BBS COMMUNITY</p>
          <div className="block lg:hidden">
          <Image src="/x_city/take_me_home_box.svg" width={95} height={43}  layout="fixed"/>
          </div>
        ...
        <div className="flex flex-row justify-around lg:justify-between lg:w-5/6">
